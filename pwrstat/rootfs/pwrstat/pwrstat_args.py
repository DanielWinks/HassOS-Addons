...
_args = vars(_parser.parse__args())
...
_mqtt_config["port"] = _args["mqtt_port"]
_mqtt_config["client_id"] = _args["mqtt_clientid"]
_mqtt_config["topic"] = _args["mqtt_topic"]
_mqtt_config["refresh"] = _args["mqtt_refresh"]
_mqtt_config["qos"] = _args["mqtt_qos"]
...
_rest_config["port"] = _args["rest_port"]
_rest_config["bind_address"] = _args["rest_bind_address"]

_prometheus_config["port"] = _args["prom_port"]
